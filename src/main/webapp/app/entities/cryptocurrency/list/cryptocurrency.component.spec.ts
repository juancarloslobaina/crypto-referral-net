...
describe('Cryptocurrency Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'cryptocurrency', component: CryptocurrencyComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cryptocurrencies?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to cryptocurrencyService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCryptocurrencyIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCryptocurrencyIdentifier).toHaveBeenCalledWith(entity);
