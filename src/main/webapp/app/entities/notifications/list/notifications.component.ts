...
import { EntityArrayResponseType, NotificationsService } from '../service/notifications.service';
...
export class NotificationsComponent implements OnInit {
  ...
  trackId = (_index: number, item: INotifications): number => this.notificationsService.getNotificationsIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: INotifications[] | null): INotifications[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.notificationsService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
