...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, es.qabit.crypto.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, es.qabit.crypto.repository.UserRepository.USERS_BY_EMAIL_CACHE);
