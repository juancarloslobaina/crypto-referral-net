package es.qabit.crypto.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof es.qabit.crypto.service.EmailAlreadyUsedException ||
            ex instanceof es.qabit.crypto.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof es.qabit.crypto.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "es.qabit.crypto");
    }
}
