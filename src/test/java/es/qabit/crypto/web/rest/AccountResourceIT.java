...
import es.qabit.crypto.repository.AuthorityRepository;
...
import es.qabit.crypto.service.dto.PasswordChangeDTO;
import es.qabit.crypto.web.rest.vm.KeyAndPasswordVM;
import es.qabit.crypto.web.rest.vm.ManagedUserVM;
